...
#Frame Corpo
frame_corpo = Frame(janela, width=235, height=352, bg=cor4)
...
#Função Apagar ultimo caractere
def apagar():
    global todos_valores
...
b_2 = Button(frame_corpo, command= lambda: entrar_valores("%"), text="%", width=5, height=2, bg=cor5, fg=cor2, font='Ivy 13 bold', relief=RAISED, overrelief=RIDGE)
b_2.place(x=177, y=260)
...
b_19 = Button(frame_corpo, command= lambda: entrar_valores("("), text="(", width=5, height=2, bg=cor4, fg=cor1, font='Ivy 13 bold', relief=RAISED, overrelief=RIDGE)
b_19.place(x=0, y=260)

b_20 = Button(frame_corpo, command= lambda: entrar_valores(")"), text=")", width=5, height=2, bg=cor4, fg=cor1, font='Ivy 13 bold', relief=RAISED, overrelief=RIDGE)
b_20.place(x=59, y=260)

b_21 = Button(frame_corpo, command= lambda: entrar_valores("**"), text="EXP", width=5, height=2, bg=cor4, fg=cor1, font='Ivy 13 bold', relief=RAISED, overrelief=RIDGE)
b_21.place(x=118, y=260)

b_22 = Button(frame_corpo, command= apagar, text="←", width=5, height=2, bg=cor4, fg=cor1, font='Ivy 13 bold', relief=RAISED, overrelief=RIDGE)
b_22.place(x=118, y=0)
